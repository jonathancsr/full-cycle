...
message = chat_model.invoke("Hey my name is Jonathan")
print("Assistant : ", message.content)
print("-"*30)

message = chat_model.invoke("Can you repeat my name?")
print("Assistant : ", message.content)
print("-"*30)
...
# Interactions
response1 = conversational_chain.invoke({"input": "Hello, my name is Jonathan. How are you?"}, config=config)
...
response3 = conversational_chain.invoke({"input": "Can you repeat my name in a motivation speech?"}, config=config)
