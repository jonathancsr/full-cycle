...
# map_reduce pede um resumo de cada parte para a IA e depois faz a sumarização de todos os resumos
chain_summarize = load_summarize_chain(
    llm,  # Modelo de linguagem a ser usado para sumarização
    chain_type="map_reduce",  # Tipo de chain: "map_reduce" resume cada parte separadamente e depois combina os resumos
